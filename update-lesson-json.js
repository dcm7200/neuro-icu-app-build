...
const lessonContent = JSON.stringify({
  blocks: [
    ...
    },
    {
      id: '8',
      type: 'paragraph',
      content: { text: 'Gold standard for consciousness documentation. Score ranges from 3-15.' }
    },
    {
      id: '9',
      type: 'heading',
    ...
    },
    {
      id: '13',
      type: 'heading',
      content: { text: 'Prognostic Interpretation' }
    },
    {
      id: '14',
      type: 'table',
      content: {
        headers: ['GCS Range', 'Severity', 'Prognosis'],
        rows: [
          ['3-5', 'Very Severe', 'Often irreversible damage'],
          ['6-8', 'Severe', 'Significant morbidity expected'],
          ['9-12', 'Moderate', 'Variable outcomes'],
          ['13-15', 'Mild', 'Generally better prognosis']
        ]
      }
    },
    {
    ...
    },
    {
      id: '16',
      type: 'video',
      content: { url: 'https://youtu.be/YFk3TEgaiTM', caption: 'Focused Neuro Exam in the Comatose Patient' }
    },
    {
      id: '17',
      type: 'heading',
...
async function updateLesson() {
  try {
    console.log('Updating lesson with JSON content...');
    ...
    console.log('🎉 Visit http://localhost:3000/modules to view');
  } catch (error) {
